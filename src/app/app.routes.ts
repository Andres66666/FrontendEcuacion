...
import { ItemsGastoOperacion } from './components/gestion_proyectos/items-gasto-operacion/items-gasto-operacion';
...
export const routes: Routes = [
...

  {
    ...
    children: [
      ...
      { path: 'ItemsGastoOperacion', component: ItemsGastoOperacion },
